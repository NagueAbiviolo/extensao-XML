...
const XmlParser = (() => {
    ...
    /**
     * Parse genérico: pega todos os elementos folha e cria chave = tagName, valor = textContent.
     * Usa caminho parcial para evitar colisões.
     */
    function parseGeneric(element, prefix) {
        const dados = {};
        ...
        // Contabiliza tags repetidas para numerar
        const tagCounts = {};
        ...
        for (const child of children) {
            ...
            const childData = parseGeneric(child, childKey);
            // Mantém o primeiro valor encontrado para cada chave
